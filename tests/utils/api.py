...
def create_location_response(location_id: int, name: str, lat: float, lon: float) -> Dict[str, Any]:
...
def simulate_rate_limit(mock_func: AsyncMock, success_response: Dict[str, Any],
                       attempts: int = 3) -> AsyncMock:
    """
