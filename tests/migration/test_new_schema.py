...
from src.models_new import MonitoringTarget, ChannelConfig, Base
...
class TestNewSchemaValidation:
    ...
    def test_valid_location_target(self):
        ...
        with self.Session() as session:
            ...
            assert saved_target.radius_miles is None
    ...
    def test_invalid_target_type(self):
        ...
        with self.Session() as session:
            ...
            with pytest.raises(ValueError, match="target_type must be 'location' or 'geographic'"):
                target = MonitoringTarget(
                    channel_id=12345,
    ...
    def test_radius_validation(self):
        ...
        with self.Session() as session:
            ...
            with pytest.raises(ValueError, match="radius_miles must be between 1 and 100"):
                target = MonitoringTarget(
                    channel_id=12345,
                    target_type='geographic',
    ...
    def test_helper_methods(self):
        ...
        with self.Session() as session:
            ...
            assert location_target.format_coordinates_display() == ""
            ...
            assert "30.26715" in geo_target.format_coordinates_display()
            assert "5 miles" in geo_target.format_coordinates_display()
