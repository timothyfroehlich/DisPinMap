...
class TestManualCheckBehavior:
    ...
    async def test_manual_check_uses_min_date_false_for_location(
    ...
    async def test_manual_check_uses_min_date_false_for_coordinates(
        self, mock_fetch, monitor, db, mock_bot
    ):
        """
    ...
    @patch("src.cogs.monitor.fetch_submissions_for_location", new_callable=AsyncMock)
    async def test_manual_check_hybrid_model_new_plus_old(
    ...
    @patch("src.cogs.monitor.fetch_submissions_for_location", new_callable=AsyncMock)
    async def test_manual_check_shows_all_when_less_than_five_available(
        self, mock_fetch, monitor, db, mock_bot, mock_notifier
    ):
        """
    ...
    @patch("src.cogs.monitor.fetch_submissions_for_location", new_callable=AsyncMock)
    async def test_manual_check_no_time_limits(
        self, mock_fetch, monitor, db, mock_bot, mock_notifier
    ):
        """
    ...
    @patch("src.cogs.monitor.fetch_submissions_for_location", new_callable=AsyncMock)
    async def test_manual_check_provides_feedback_no_new_submissions(
        self, mock_fetch, monitor, db, mock_bot, mock_notifier
    ):
        """
    ...
    @patch("src.cogs.monitor.fetch_submissions_for_location", new_callable=AsyncMock)
    async def test_manual_check_handles_no_previous_poll(
        self, mock_fetch, monitor, db, mock_bot, mock_notifier
    ):
        """
    ...
    @patch("src.cogs.monitor.fetch_submissions_for_location", new_callable=AsyncMock)
    async def test_manual_check_updates_poll_timestamp(
        self, mock_fetch, monitor, db, mock_bot
    ):
        """
    ...
    @patch("src.cogs.monitor.fetch_submissions_for_location", new_callable=AsyncMock)
    async def test_manual_check_sends_explicit_error_messages(
        self, mock_fetch, monitor, db, mock_bot, mock_notifier
    ):
        """
    ...
    async def test_check_command_handles_missing_monitor_cog(
