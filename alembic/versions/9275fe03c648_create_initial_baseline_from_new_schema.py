...
Revision ID: 9275fe03c648
Revises: 
Create Date: 2025-07-02 19:36:16.240555
...
def upgrade() -> None:
    ...
    sa.CheckConstraint("target_type IN ('location', 'geographic')", name='valid_target_type'),
    ...
    sa.CheckConstraint('radius_miles IS NULL OR (radius_miles >= 1 AND radius_miles <= 100)', name='valid_radius'),
    sa.ForeignKeyConstraint(['channel_id'], ['channel_configs.channel_id'], ),
    sa.PrimaryKeyConstraint('id'),
    sa.UniqueConstraint('channel_id', 'latitude', 'longitude', name='unique_geographic'),
    sa.UniqueConstraint('channel_id', 'location_id', name='unique_location')
    )
    op.create_table('seen_submissions',
    sa.Column('id', sa.Integer(), autoincrement=True, nullable=False),
    sa.Column('channel_id', sa.BigInteger(), nullable=False),
    ...
    sa.ForeignKeyConstraint(['channel_id'], ['channel_configs.channel_id'], ),
    sa.PrimaryKeyConstraint('id'),
    sa.UniqueConstraint('channel_id', 'submission_id', name='unique_channel_submission')
    )
