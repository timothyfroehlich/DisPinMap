...
class FileWatcher:
    ...
    def __init__(self, command_processor: Callable[[str], Awaitable[None]], 
    ...
    def _log_usage_instructions(self):
    ...
    def get_stats(self) -> dict:
        ...
        return {
            ...
            "file_size": os.path.getsize(self.command_file) if os.path.exists(self.command_file) else 0,
...
async def create_file_watcher(command_processor: Callable[[str], Awaitable[None]], 
                            command_file: str = "commands.txt") -> FileWatcher:
    """
